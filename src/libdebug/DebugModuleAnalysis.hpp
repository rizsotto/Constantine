...
class DebugModuleAnalysis : public clang::ASTConsumer {
public:
    DebugModuleAnalysis(clang::CompilerInstance const &, Target);

    void HandleTranslationUnit(clang::ASTContext &) override;

    DebugModuleAnalysis(DebugModuleAnalysis const &) = delete;
    DebugModuleAnalysis & operator=(DebugModuleAnalysis const &) = delete;
