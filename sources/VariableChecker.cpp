...
bool check(VariablesByContext const & AllCtxs, ContextsByVariable::value_type It) {
...
void report(clang::DiagnosticsEngine & DiagEng, ContextsByVariable::value_type It) {
